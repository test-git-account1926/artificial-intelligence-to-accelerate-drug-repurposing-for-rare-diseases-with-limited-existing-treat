...
2. **Model Training Automation**:
   ...
   * Train minimal model with curated high-signal features (less than 500 features)
...
* **Strong Success**: Minimal model achieves >20% better actionable accuracy with pless than 0.01
* **Moderate Success**: Minimal model achieves >10% better actionable accuracy with pless than 0.05
...
* **Moderate Success**: Actionability model shows >15% better clinical outcomes with less than 5% accuracy loss
...
* **Impact Validation**: Success enables AI for ultra-rare diseases with less than 100 patients, potentially helping thousands of conditions
...
2. **Disease Stratification**:
   * Automatically categorize diseases by data availability (>1000, 100-1000, less than 100 patients)
...
* **Strong Success**: Transfer learning achieves >40% better performance on ultra-rare diseases (nless than 100)
...
* Evaluate few-shot learning curves - if no improvement with less than 50 samples, assumption about ultra-rare diseases may be wrong
...
* **Invalidation Test**: Compare safety signal detection on historical cases - if parallel catches less than 90% of sequential signals, assumption holds
